...
tic;
disp(['start read PSF....'])
PSF_1=load('/home/data2/backup_customer/kexin/fishData/PSFr210825.mat','PSF_1');
PSF_1=PSF_1.PSF_1;
BkgMean=140;
PSF_1=single(PSF_1);
...
rootPath='//home/data2/backup_customer/kexin/fishData/210824/';
rawPath=[rootPath,'raw/'];

objPath=[rootPath,'recon/'];
if ~exist(objPath,'dir')
    mkdir(objPath);
end
mipPath=[rootPath,'MIP/'];
