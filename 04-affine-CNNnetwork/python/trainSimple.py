...
import affineNetworkSimple as affineNet


trainingPath="/home/customer/kexin/pytorchTest/allDataset/random2DAffine_balance/train"
validationPath="/home/customer/kexin/pytorchTest/allDataset/random2DAffine_balance/val"
...
def training(training_params):
    ...
    # test
    testLoss=0
    testSize=len(validation_dataloader.dataset)
    ...
    with torch.set_grad_enabled(False):
        for data in validation_dataloader:
            ...
            loss=loss_function(matrix_caculate,affineMatrices)
            testLoss += loss.item()
    print("test Loss: ", testLoss / (testSize/batch_size))
...
def run():
    ...
    training_params['model_name'] = 'affineNet_1028_batch128_fake2DAffine_balance.pt' # TO DEFINE
    training_params['num_epochs'] = 500
    training_params['batch_size'] = 128
    training_params['learning_rate'] = 0.0002
